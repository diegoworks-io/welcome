export function Hero() {
  return `
    <section id="hero-wrapper" class="relative h-[200vh]">
      <div id="hero-section"
           class="sticky top-0 flex flex-col items-center justify-center min-h-screen bg-black text-white font-sans px-4">
        ...
        <h1 id="hero-title"
            class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold mb-3 sm:mb-4 md:mb-6 text-center leading-tight md:leading-snug lg:leading-normal">
          Operational clarity<br class="hidden sm:inline" /> for SMEs
        </h1>

        <p id="hero-subtitle"
           class="text-base sm:text-lg md:text-xl opacity-80 mb-6 sm:mb-8 md:mb-10 text-center max-w-xs sm:max-w-md md:max-w-xl lg:max-w-2xl mx-auto leading-relaxed">
